...
- **1.0.0** — generalized for the `engineering-paved-path` plugin: repository-specific paths and package names replaced with generic equivalents; repository-local convention references removed.
